...
urlpatterns = [
    ...
    path('image-finder/', ImageFinderView.as_view(), name='image_finder'),
  ...
  # urls for reported person create, update verify, delete
    ...
    path('clear-model-images/', ClearModelImages.as_view(), name='clear_model_images'),
    path('clear-model-images-success/', ClearModelImagesSuccessView.as_view(), name='clear_model_images_success'),
    ...
    path('image-person-finder-form-success/', MissingPersonFormSuccessView.as_view(), name='image-person-finder-form-success'),
